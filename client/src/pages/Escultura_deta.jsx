  ...
  return (
    <div className="container mx-auto p-4">
      <div className="flex flex-col items-center">
        <img src={escultura.imagen} alt={escultura.nombre} className="w-full max-w-md object-cover" />
        <h1 className="text-3xl font-bold mt-4 text-white">{escultura.nombre}</h1>
...
export default EsculturaDetail;
